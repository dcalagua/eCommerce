-- =============================================================================
-- P10 · `create_order` aplica el limite de tasa del checkout
-- 23/23 — Engancha `ebim.assert_checkout_allowed` en la funcion de pedido, justo
--         despues de validar tienda y correo y ANTES de descontar stock o
--         consumir el contador de numero de pedido: un rechazo tardio ya habria
--         gastado recursos de la tienda.
--
-- Va en la misma transaccion que el pedido, asi que contar y crear son atomicos:
-- no hay ventana en la que dos peticiones simultaneas pasen el mismo hueco.
-- =============================================================================
