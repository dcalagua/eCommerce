-- =============================================================================
-- P11 · `create_order` devuelve el token de acceso del comprador
-- 25/25 — El token lo genera el DEFAULT de la columna al insertar; aqui solo se
--         captura con `returning` y se devuelve. Es el unico momento en que sale
--         de la base, y sale hacia quien acaba de pagar.
-- =============================================================================
